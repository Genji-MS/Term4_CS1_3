...
class BinaryTreeNode(object):
    ...
    def is_leaf(self):
        ...
        return (False,True)[self.left == None and self.right == None]

    def is_branch(self):
        """Return True if this node is a branch (has at least one child)."""
        # TODO: Check if either left child or right child has a value
        return (False,True)[self.left != None or self.right != None]
...
class BinarySearchTree(object):
    ...
    def insert(self, item):
        ...
        if self.is_empty():
            ...
            self.size += 1
            return
        # Find the parent node of where the given item should be inserte=
    ...
    def _find_node_recursive(self, item, node):
        ...
        # TODO: Check if the given item is greater than the node's data
            ...
            # TOD√O: Recursively descend to the node's right child, if it exists
    ...
    def _find_parent_node_recursive(self, item, node, parent=None):
        ...
        print (f'item = {item} node = {node} parent = {parent}')
        # Check if starting node exists
        if node is None:
            # Not found (base case)
            return None
        ...
        # √: Check if the given item is less than the node's data
            ...
            # √: Recursively descend to the node's left child, if it exists
            if node.left != None:
                return self._find_parent_node_recursive(item, node.left, parent=node.left)  # Hint: Remember to update the parent parameter
        # √: Check if the given item is greater than the node's data
        elif item > node.data:
            # √: Recursively descend to the node's right child, if it exists
            if node.right != None:
                return self._find_parent_node_recursive(item, node.right, parent=node.right)  # Hint: Remember to update the parent parameter
        return parent
